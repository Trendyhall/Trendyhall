					...
					<a href="/goods/<?php echo $value['modelcode'].'_'.$value['colour']; ?>">
					    <div class="card h-100">
					        ...
					        <div class="card-body">
				        		...
				        		<?php if ($value['sale'] == 1): ?>
				        			<div class="card-price"><?php echo number_format($value['price'], 2,"."," "); ?> &#8381; </div>
				        		<?php endif; ?>
				        		<?php if ($value['sale'] != 1): ?>
				        			<div style="font-size: 1rem; text-decoration: line-through;"><?php echo number_format($value['price'], 2,"."," "); ?> &#8381;</div>
				        			<div class="card-price" style="color: #f00;"><?php echo number_format($value['price'] * (0.01 * (100 - $Sale)), 2,"."," "); ?> &#8381;</div>
				        		<?php endif; ?>
					        </div>
					    </div>
					</a>
