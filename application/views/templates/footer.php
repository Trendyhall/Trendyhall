      ...
      <div class="container-fluide">
        <div class="row">
          <div class="col-sm-6 text-sm-start mb-3">
            ...
            <a href="/contact" class="d-block">Контакты</a>
            <a href="/about-delivery" class="d-block">О доставке</a>
            <a href="/about-the-refund" class="d-block">О возврате</a>
            <div class="mb-3"></div>
            <a href="/terms" class="d-block">Пользовательское соглашение</a>
            <a href="/privacy-policy" class="d-block">Политика конфеденциальности</a>
          </div>
          <div class="col-sm-6 text-sm-start mb-3">

            <!-- Instagram -->
            <a href="https://www.instagram.com/trendy_hall_official/" class="d-block mb-2" target="blank">
              ...
              @trendy_hall_official
            </a>

            <!-- TikToc -->
            <a href="https://www.tiktok.com/@trendy_hall_official" class="d-block mb-2" target="blank">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="me-2" viewBox="3 3 18 18">
            ...
            <!-- WhatsApp -->
            <a href="https://wa.me/74952257390" class="d-block mb-2" target="blank">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="me-2" viewBox="0 0 16 16">
